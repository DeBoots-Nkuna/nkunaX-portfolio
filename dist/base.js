...
function shouldBypassNavigation(event, el) {
...
function navigateAfterDelay(el, delayMs) {
    var _a;
    const href = el.href;
    const target = (_a = el.getAttribute('target')) !== null && _a !== void 0 ? _a : '_self';
    window.setTimeout(() => {
        if (target === '_self') {
